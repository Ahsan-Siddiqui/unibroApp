  ...
  _renderItemRO = ({ item, index }) => {
    ...
    return (
      ...
      >
        ...
        <PoppinsBold style={{ color: '#012c65',fontSize: 4 * vw,marginBottom:1*vh }}>{item.title}</PoppinsBold>
        <PoppinsRegular style={{ fontSize: 3 * vw,fontWeight:'bold',color:'black',textAlign:'center' }}>{item.value}</PoppinsRegular>
