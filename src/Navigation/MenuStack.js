...
import GreyFabricStockInHand from '../Screens/GreyFabricStockInHand';
...
import GreyFabricOutStanding from '../Screens/GreyFabricOutStanding';
...
const MenuStack = () => {
  return (
    <MenuNavigator.Navigator screenOptions={getNavigationOptions}>
      ...
      <MenuNavigator.Screen component={GreyFabricStockInHand} name="GreyFabricStkInHnd" />
      <MenuNavigator.Screen component={GreyFabricOutStanding} name="GreyFabricOutStanding" />
