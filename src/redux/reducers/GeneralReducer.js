...
const INITIAL_STATE = {
  ...
  grey_fabric_outstanding:[],//done
  grey_fabric_stock_in_hand:[],//done
...
export default GeneralReducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case
      actionTypes.GREY_FABRIC_OUSTANDING: {
        return {
          ...state,
          grey_fabric_outstanding: action.payload,
        };
      }
    case
      actionTypes.GREY_FABRIC_STOCK_IN_HAND: {
        return {
          ...state,
          grey_fabric_stock_in_hand:action.payload
        }
      }
